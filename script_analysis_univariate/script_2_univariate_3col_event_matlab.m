...
for ith = 0:3
    ...
    fid = fopen([  root_path,  ['/data_swati_ket/outputs/univariate_run',num2str(ith),'_actor_pos.txt']],'w');
    ...
    output_table = [mess_onset, mess_end-mess_onset, mess_value];
    fid = fopen([  root_path,  ['/data_swati_ket/outputs/univariate_run',num2str(ith),'_actor_neg.txt']],'w');
    for n = 1:length(output_table(:,1))
        fprintf(fid,'%f\t  %f\t  %d\n',output_table(n,:));
    end
    fclose(fid);
    ...
    fid = fopen([  root_path,  ['/data_swati_ket/outputs/univariate_run',num2str(ith),'_likesReceived.txt']],'w');
    for n = 1:length(output_table(:,1))
        fprintf(fid,'%f\t  %f\t  %d\n',output_table(n,:));
    end
    ...
    fid = fopen([  root_path,  ['/data_swati_ket/outputs/univariate_run',num2str(ith),'_dislikesReceived.txt']],'w');
    for n = 1:length(output_table(:,1))
        fprintf(fid,'%f\t  %f\t  %d\n',output_table(n,:));
    end
    ...
    fid = fopen([  root_path,  ['/data_swati_ket/outputs/univariate_run',num2str(ith),'_LikesGiven.txt']],'w');
    for n = 1:length(output_table(:,1))
        fprintf(fid,'%f\t  %f\t  %d\n',output_table(n,:));
    end
    ...
    fid = fopen([  root_path,  ['/data_swati_ket/outputs/univariate_run',num2str(ith),'_DislikesGiven.txt']],'w');
    for n = 1:length(output_table(:,1))
        fprintf(fid,'%f\t  %f\t  %d\n',output_table(n,:));
    end
    ...
    fid = fopen([  root_path,  ['/data_swati_ket/outputs/univariate_run',num2str(ith),'_rewardPunish.txt']],'w');
    for n = 1:length(output_table(:,1))
        fprintf(fid,'%f\t  %f\t  %d\n',output_table(n,:));
    end
    ...
    fid = fopen([  root_path,  ['/data_swati_ket/outputs/univariate_run',num2str(ith),'_likabilityRev.txt']],'w');
    for n = 1:length(output_table(:,1))
        fprintf(fid,'%f\t  %f\t  %d\n',output_table(n,:));
    end
    ...
    fid = fopen([  root_path,  ['/data_swati_ket/outputs/univariate_run',num2str(ith),'_likability.txt']],'w');
    for n = 1:length(output_table(:,1))
        fprintf(fid,'%f\t  %f\t  %d\n',output_table(n,:));
    end
    ...
    fid = fopen([  root_path,  ['/data_swati_ket/outputs/univariate_run',num2str(ith),'_feelings.txt']],'w');
    for n = 1:length(output_table(:,1))
        fprintf(fid,'%f\t  %f\t  %d\n',output_table(n,:));
    end
    ...
    fid = fopen([  root_path,  ['/data_swati_ket/outputs/univariate_run',num2str(ith),'_fixate.txt']],'w');
    for n = 1:length(output_table(:,1))
        fprintf(fid,'%f\t  %f\t  %d\n',output_table(n,:));
    end
    ...
    fid = fopen([  root_path,  ['/data_swati_ket/outputs/univariate_run',num2str(ith),'_prompt.txt']],'w');
    for n = 1:length(output_table(:,1))
        fprintf(fid,'%f\t  %f\t  %d\n',output_table(n,:));
    end
